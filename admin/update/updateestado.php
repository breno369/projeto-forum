...
<body>
  ...
  if (isset($_GET['id'])) {
    $id = $pdo->selectID($_GET['id'], 'estado');
  // var_dump($id);
  }
  ?>
    ...
    <form action="" method="POST" class="col-6 p-4 needs-validation" novalidate>
      ...
      <div class="input-group mb-3">
        ...
        <input type="text" class="form-control" placeholder="Estado " aria-label="Estado"
          aria-describedby="basic-addon1" name="estado" required value="<?php echo $id['estado']; ?>">
  ...
  if ($_POST != null) {
    $updateestado = $pdo->update('estado', $_POST['estado'], $_POST['id'], null);
